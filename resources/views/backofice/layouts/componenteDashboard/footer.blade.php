        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-4 col-md-2 item">
                   <img src="{{ asset('assets/img/royal_green/logos/logo.svg') }}" style="margin-left: -35px; margin-top: -20px;" alt="">
                   <p style="margin-left: -20px;">Sigue nuestras redes sociales</p><br>
                   <div class="d-flex">
                    <img src="{{ asset('assets/img/home/facebook1.png') }}" style="margin-left: -22px; margin-top: -20px;" alt="">
                    <img src="{{ asset('assets/img/home/instagram1.png') }}" style="margin-left: 30px; margin-top: -20px;" alt="">
                   </div>
                </div>
                <div class="col-sm-4 col-md-2 item">
